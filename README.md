...
Сага доводит транзакцию только до `unconfirmed` и возвращает ответ — финальный статус доводит фоновый block-scanner. Ключевые части архитектуры разобраны отдельно:
